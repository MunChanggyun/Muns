        ...
        ================================================== -->
         <div class="span8" style="margin-bottom:100px;">
            ...
            <div class="container" style="width:115%;text-align:center;">
               ...
               <form id="frm" action="<%= request.getContextPath() %>/Write.board?categoryCode=2" method="post" enctype="multipart/form-data">
               		<table style="width:100%;">
                    	<tr>
                        	<td style="width:100px"><h4>제목</h4></td>
                            <td>
                            	<select name="titleHead" id="titleHead" class="form-control input-sm" style="width:15%;float:left;height:35px;">
                              		<option value=" ">글머리</option>
                              		<option value="[ 품앗이 ] ">[ 품앗이 ]</option>
                              		<option value="[ 나눔장터 ] ">[ 나눔장터 ]</option>
                              		<option value="[ 정보공유 ] ">[ 정보공유 ]</option>
                              		<option value="[ 기타 ] ">[ 기타 ]</option>
                              	</select>
                                <input style="width:70%;height:30px;" type="text" id="boardTitle" name="boardTitle"/>
                              </td>
                           </tr>
                           <tr>
                              <td><h4>내용</h4></td>
                           ...
                           <tr>
                              ...
                              <td style="padding-left: 30px;position:absolute;left:50%;">
                                 <input style="width:100px;height:40px;margin:20px" type="submit" class="btn btn-inverse" id="savebutton" value="글쓰기" /> 
                                 <input style="width:100px;height:40px;margin:20px" type="button" class="btn btn-inverse" onclick="location.href='<%=request.getContextPath()%>/Certain.board?categoryCode=2'" id="canclebutton" value="취소" />
                              </td>
                           </tr>
                        </table>
                     </form>
