        ...
        ================================================== -->
         <div class="span8" style="margin-bottom:100px;">
            ...
            <div class="container" style="width:115%;text-align:center;">
               ...
               <form id="frm" action="<%= request.getContextPath() %>/Write.board?categoryCode=1" method="post" enctype="multipart/form-data">
               		<table style="width:100%;">
                           ...
                           <tr>
                              ...
                              <td style="padding-left: 30px;position:absolute;left:50%;">
                                 ...
                                 <input style="width:100px;height:40px;margin:20px" type="button" class="btn btn-inverse" id="canclebutton" onclick="location.href='<%=request.getContextPath()%>/Certain.board?categoryCode=1'" value="취소" />
                              </td>
                           </tr>
                        </table>
                     </form>
